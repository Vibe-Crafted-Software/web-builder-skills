...
Internal Claude Code plugin bundling five reusable "web builder"
playbooks as Skills — SEO, homepage sales copy, contact-form
integration, and South Africa-first Terms of Use templates (website +
software). Originally drafted in the `VCS_Website` project; this repo is
the maintained, cross-project source going forward.
...
Five skills, one plugin (`skills/<name>/SKILL.md` + a
